  ...
  <div class="main-layout dashboard-main-layout">
    ...
    <div class="main-content">
      ...
      <div id="panel-students" class="hidden">
        <div class="toolbar">
          <input type="search" id="search-students" placeholder="Search students…" autocomplete="off">
      ...
      <div id="panel-beneficiary-requests" class="hidden">
        <div class="toolbar">
          <input type="search" id="search-beneficiary-requests" placeholder="Search students…" autocomplete="off">
      ...
      <div id="panel-users" class="hidden">
        <div class="toolbar">
          <input type="search" id="search-users" placeholder="Search users…" autocomplete="off">
